...
epBonilla <- function(problemInfo) {
	...
	problemInfo$lengthScaleItems <- log(read.table("../tuneKernelParametersBonilla/lengthScaleItems.txt")$V1)
	problemInfo$lengthScaleUsers <- log(read.table("../tuneKernelParametersBonilla/lengthScaleUsers.txt")$V1)
	problemInfo$noiseUsers <- log(read.table("../tuneKernelParametersBonilla/noiseUsers.txt")$V1)
	problemInfo$noiseItems <- log(read.table("../tuneKernelParametersBonilla/noiseItems.txt")$V1)
