...
epBonilla <- function(problemInfo) {
	...
	problemInfo$noiseUsers <- log(0.1)

	# We load the kernel parameters

#	problemInfo$lengthScaleItems <- log(read.table("../../tuneKernelParametersBonilla/epBonillaTuneKernelParameters/lengthScaleItems.txt")$V1)
#	problemInfo$lengthScaleUsers <- log(read.table("../../tuneKernelParametersBonilla/epBonillaTuneKernelParameters/lengthScaleUsers.txt")$V1)
#	problemInfo$noiseUsers <- log(read.table("../../tuneKernelParametersBonilla/epBonillaTuneKernelParameters/noiseUsers.txt")$V1)
#	problemInfo$noiseItems <- log(read.table("../../tuneKernelParametersBonilla/epBonillaTuneKernelParameters/noiseItems.txt")$V1)
